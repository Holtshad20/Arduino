...
void showPrivate(EthernetClient client, TextFinder finder, boolean isPost)
{
...
void htmlButton( EthernetClient client, char * label, char *name, int nameId, char *value)
{
  P(buttonBegin) = 
