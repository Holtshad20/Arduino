...
// mouse library from :  http://www.arduino.cc/playground/ComponentLib/Ps2mouse
#include <ps2.h>
...
void setup()
{
  Serial.begin(115200);  // note the higher than usual serial speed
  mouseBegin();
}

// get a reading from mouse and report it back to the host via the serial line
void loop()
{
