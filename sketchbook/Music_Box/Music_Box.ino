...
char *sons[] = {" ",
                "GunsAndR:d=4,o=6,b=225:d5,d,a5,g5,g,a5,f_,d5,d,a5,g5,g,a5,f_,a5,e5,d,a5,g,a5,f_,a5,e5,d,a5,g5,g,a5,f_,a5,f_,a5,e5,d,a5,g5,g,a5,f_,a5",
...
void setup()
{
  ButtonEvent.addButton(2,       //button pin
...
void onDown(ButtonInformation* Sender) {
  ...
  if ((som>=1)&&(som<=7)) play_rtttl(sons[som]); 
  //if (som==0) tone1.stop(); 
  
/*  if (som==1) play_rtttl(song1);  
  else if (som==2) play_rtttl(song2);    
  else if (som==3) play_rtttl(song3);  
  else tone1.stop();    */
}
